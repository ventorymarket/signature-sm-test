...
const VENOM_TESTNET_TRACE_ENDPOINT =
  process.env.VENOM_TESTNET_TRACE_ENDPOINT || "https://gql-testnet.venom.network/graphql";
...
const config: LockliftConfig = {
  ...
  networks: {
    ...
    venom_testnet: {
      ...
      giver: {
        address: "0:7f9eba415b2c46dcbcb00f176724e73b08be7a12fba223b3c21b924365659ecd",
        phrase: "cross goose screen sustain message cat fall umbrella day install raccoon fame",
        accountId: 0,
      },
      tracing: {
